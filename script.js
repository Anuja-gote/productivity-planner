...
const addNewToDo = () => {
    ...
    if (toDoInput.value != ''){
        ...
        localStorage.setItem("Todo item "+key++,toDoInput.value);
...
const createToolAreal = () => {
    ...
    buttonDone.innerHTML = '<i class="fas fa-check" key={'+key+'}></i>'
    ...
    buttonCancel.innerHTML = '<i class="fas fa-times">delete</i>'
